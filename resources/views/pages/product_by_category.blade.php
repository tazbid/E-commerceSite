              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      <img src="{{URL::to($v_product_by_category->product_image) }}" style="height: 230px;" alt="" />
                      <h2>{{$v_product_by_category->product_price}}<span> BDT</span></h2>
                ...
                <div class="choose">
                  <ul class="nav nav-pills nav-justified">
                    <li><a href="{{URL::to('/view_product/'.$v_product_by_category->product_id)}}"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
