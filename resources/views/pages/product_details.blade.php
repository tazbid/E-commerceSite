					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>Color: {{$view_product->product_color}}</p>
								<img src="{{URL::to('frontend/images/product-details/rating.png')}}" alt="" />
								<span>
									<span>{{$view_product->product_price}} BDT</span>
								...
								<p><b>Brand:</b>{{$view_product->brand_name}}</p>
								<p><b>Category:</b>{{$view_product->category_name}}</p>
								<p><b>Size:</b>{{$view_product->product_size}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="details" >
								<p>{{$view_product->product_long_description}}</p>						
							</div>
