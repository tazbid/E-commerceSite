	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>ShoppE</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a href="{{URL::to('/all_category')}}"><i class="icon-envelope"></i><span class="hidden-tablet">All Categories</span></a>
						</li>
						<li>
							<a href="{{URL::to('/add_category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a>
						</li>
						<li>
							<a href="{{URL::to('/all_brands')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Brands</span></a>
						</li>
						<li>
							<a href="{{URL::to('/add_brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Brand</span></a>
						</li>
						<li>
						...
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Admins</span></a>
							<ul>
								<li><a class="submenu" href="{{URL::to('/all_admin')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">All Admins</span></a></li>
								<li><a class="submenu" href="{{URL::to('/add_admin')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Admin</span></a></li>
							</ul>	
						</li>
						<li>
						...
						<li>
							<a href="{{URL::to('/manage_order')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage Order</span></a>
						</li>
					</ul>
				</div>
			</div>
